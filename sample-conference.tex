...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\documentclass[minor, conference, anonymous]{responseletter}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%   FILL IN YOUR MANUSCRIPT DETAILS HERE
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\manuscriptid{CONFERENCE-XXX}
...
For example, for submissions to journals like TOSEM, you can use \texttt{\textbackslash{reviewer}}, while for submissions to conferences hosted on HotCRP, you can use \texttt{\textbackslash{reviewer}\string[\textbackslash{\#}123A\string]}.
